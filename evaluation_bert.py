...
def parse_command_line_arguments():
    ...
    parser.add_argument('--model', default="./results/qa/checkpoint-13690", help="the name of the model/checkpoint to be used for the classifier (e.g. ./results/checkpoint")
